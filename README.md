...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/click-rich-help-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14594&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/click-rich-help-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `click-rich-help` can be installed with:

```
conda install click-rich-help
```

It is possible to list all of the versions of `click-rich-help` available on your platform with:
